...
import 'package:flutter_paypal_test/paypal_services.dart';
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  Map<String, dynamic> getOrderParams() {
    ...
    String userFirstName = 'Shafqat';
    String userLastName = 'Nadeem';
    String addressCity = 'Lahore';
    String addressStreet = 'Canal Road';
    String addressZipCode = '110014';
    String addressCountry = 'Pakistan';
    String addressState = 'Punjab';
    String addressPhoneNumber = '+923417341950';
